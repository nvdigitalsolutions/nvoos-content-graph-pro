<?php
/**
 * Architectural_Specification_Research_Page (ecosystem port - Wave F2, architectural-design admin slice).
 *
...
class WP_MCP_AI_Architectural_Specification_Research_Page {
	...
	public static function add_menu_page() {
		add_submenu_page(
			...
			__( 'Research & Add Specifications', 'nvoos-content-graph-pro' ),
			__( 'Research Specifications', 'nvoos-content-graph-pro' ),
			'edit_posts',
			self::PAGE_SLUG,
	...
	public static function render_page() {
		...
		<div class="wrap wp-mcp-ai-research-page">
			<h1 class="wp-heading-inline">
				<?php esc_html_e( 'Research & Add Architectural Specifications', 'nvoos-content-graph-pro' ); ?>
			</h1>
			...
			<div class="wp-mcp-ai-research-container">
				<div class="wp-mcp-ai-research-sidebar">
					<div class="wp-mcp-ai-research-intro">
						...
						<ol>
							<li><?php esc_html_e( 'Write professional construction specifications', 'nvoos-content-graph-pro' ); ?></li>
							<li><?php esc_html_e( 'Follow CSI MasterFormat standards', 'nvoos-content-graph-pro' ); ?></li>
							<li><?php esc_html_e( 'Organize by division and section numbers', 'nvoos-content-graph-pro' ); ?></li>
							<li><?php esc_html_e( 'Include three-part section structure', 'nvoos-content-graph-pro' ); ?></li>
						</ol>
					</div>

					<div class="wp-mcp-ai-research-tips">
						<h3><?php esc_html_e( 'Specification Tips', 'nvoos-content-graph-pro' ); ?></h3>
						<ul>
							<li><strong><?php esc_html_e( 'CSI Division:', 'nvoos-content-graph-pro' ); ?></strong> <?php esc_html_e( 'Organize by MasterFormat divisions (03-Concrete, 09-Finishes)', 'nvoos-content-graph-pro' ); ?></li>
							<li><strong><?php esc_html_e( 'Three-part:', 'nvoos-content-graph-pro' ); ?></strong> <?php esc_html_e( 'Include Part 1 (General), Part 2 (Products), Part 3 (Execution)', 'nvoos-content-graph-pro' ); ?></li>
							<li><strong><?php esc_html_e( 'Manufacturers:', 'nvoos-content-graph-pro' ); ?></strong> <?php esc_html_e( 'Specify product names, model numbers, and acceptable alternatives', 'nvoos-content-graph-pro' ); ?></li>
							<li><strong><?php esc_html_e( 'Standards:', 'nvoos-content-graph-pro' ); ?></strong> <?php esc_html_e( 'Reference industry standards (ASTM, ANSI, UL)', 'nvoos-content-graph-pro' ); ?></li>
							<li><strong><?php esc_html_e( 'CSI Reports:', 'nvoos-content-graph-pro' ); ?></strong> <?php esc_html_e( 'Request specification reports using Three-Part Format (Part 1: General/Scope/Submittals, Part 2: Products/Materials/Standards, Part 3: Execution/Installation/Quality Control)', 'nvoos-content-graph-pro' ); ?></li>
						</ul>
					</div>
					...
					<div class="wp-mcp-ai-research-examples">
						...
						<ul class="wp-mcp-ai-example-list">
							<li><button type="button" class="button button-secondary wp-mcp-ai-example-query" data-query="Write a specification for Division 03 - Concrete work">
								<?php esc_html_e( '"Write spec for Division 03 - Concrete"', 'nvoos-content-graph-pro' ); ?>
							</button></li>
							<li><button type="button" class="button button-secondary wp-mcp-ai-example-query" data-query="Create specifications for Division 09 - Interior finishes">
								<?php esc_html_e( '"Create Division 09 interior finishes spec"', 'nvoos-content-graph-pro' ); ?>
							</button></li>
							<li><button type="button" class="button button-secondary wp-mcp-ai-example-query" data-query="Generate Division 07 specifications for roofing and waterproofing">
								<?php esc_html_e( '"Generate Division 07 roofing spec"', 'nvoos-content-graph-pro' ); ?>
							</button></li>
							<li><button type="button" class="button button-secondary wp-mcp-ai-example-query" data-query="Research concrete specifications and generate a CSI MasterFormat report using comprehensive depth. Focus on ASTM standards and installation requirements.">
								<?php esc_html_e( '"Research concrete specs (CSI report)..."', 'nvoos-content-graph-pro' ); ?>
							</button></li>
						</ul>
					</div>
					...
					<div class="wp-mcp-ai-research-actions">
						...
						<p>
							<a href="<?php echo esc_url( admin_url( 'edit.php?post_type=mcp_ai_arch_spec' ) ); ?>" class="button">
								<?php esc_html_e( 'View All Specifications', 'nvoos-content-graph-pro' ); ?>
							</a>
						</p>
						<p>
							<a href="<?php echo esc_url( admin_url( 'post-new.php?post_type=mcp_ai_arch_spec' ) ); ?>" class="button">
								<?php esc_html_e( 'Add Specification Manually', 'nvoos-content-graph-pro' ); ?>
							</a>
						</p>
						<p>
					...
					<div class="wp-mcp-ai-research-related" style="background: #f0f6fc; border-left: 4px solid #2271b1; padding: 12px 16px; margin: 20px 0;">
						...
						<p style="margin: 4px 0 8px;">
							<?php esc_html_e( 'These pro toolkits use the same enhanced Research & Add experience and pair well with architectural specifications:', 'nvoos-content-graph-pro' ); ?>
						</p>
					...
					<div class="csi-divisions-reference" style="background: #f0f6fc; border-left: 4px solid #0073aa; padding: 12px 16px; margin: 20px 0;">
						<h4 style="margin-top: 0;"><?php esc_html_e( 'CSI MasterFormat Divisions', 'nvoos-content-graph-pro' ); ?></h4>
					...
					<div class="wp-mcp-ai-workflow-selector">
						...
						<div class="workflow-options">
							<button type="button" class="workflow-option active" data-workflow="research">
								...
								<p><?php esc_html_e( 'Write specifications with AI assistance', 'nvoos-content-graph-pro' ); ?></p>
							</button>
							<button type="button" class="workflow-option" data-workflow="import">
								...
								<p><?php esc_html_e( 'Bulk import specification data', 'nvoos-content-graph-pro' ); ?></p>
							</button>
							<button type="button" class="workflow-option" data-workflow="review">
								...
								<p><?php esc_html_e( 'View specification quality and completeness', 'nvoos-content-graph-pro' ); ?></p>
							</button>
						</div>
					</div>
	...
	public static function handle_create_from_research() {
		...
		if ( ! current_user_can( 'edit_posts' ) ) {
			wp_send_json_error( array( 'message' => __( 'You do not have permission to create specifications.', 'nvoos-content-graph-pro' ) ) );
		}
		...
		wp_send_json_success(
			array(
				'message'  => __( 'Architectural specification created successfully!', 'nvoos-content-graph-pro' ),
				'spec_id'  => $spec_id,
				'edit_url' => $edit_url,
			)
		);
	...
	protected static function process_import_data( $data, $format ) {
		return new WP_Error( 'not_implemented', __( 'Specification import processing coming soon', 'nvoos-content-graph-pro' ) );
	}
	...
	protected static function get_validation_schema() {
		return array(
			'required_fields'    => array(
				'title'              => __( 'Specification Title', 'nvoos-content-graph-pro' ),
				'division'           => __( 'CSI Division', 'nvoos-content-graph-pro' ),
				'specification_type' => __( 'Specification Type', 'nvoos-content-graph-pro' ),
			),
			'recommended_fields' => array(
				'part_structure' => __( 'Three-Part Structure', 'nvoos-content-graph-pro' ),
				'references'     => __( 'Industry References', 'nvoos-content-graph-pro' ),
			),
	...
	protected static function calculate_completeness() {
		...
		return array(
			...
			'missing'     => array(),
			'suggestions' => array(
				__( 'Organize all specifications by CSI MasterFormat divisions', 'nvoos-content-graph-pro' ),
				__( 'Include three-part structure (General, Products, Execution)', 'nvoos-content-graph-pro' ),
				__( 'Add manufacturer names and model numbers', 'nvoos-content-graph-pro' ),
				__( 'Reference industry standards (ASTM, ANSI, UL)', 'nvoos-content-graph-pro' ),
			),
		);
	}
	...
	protected static function calculate_quality_score( $item ) {
		...
		if ( ! empty( $item['meta']['division'] ) ) {
			...
			$issues[] = __( 'Missing CSI division', 'nvoos-content-graph-pro' );
		}

		if ( ! empty( $item['meta']['specification_type'] ) ) {
			$score += 25;
		} else {
			$issues[] = __( 'Missing specification type', 'nvoos-content-graph-pro' );
		}

		if ( ! empty( $item['meta']['part_structure'] ) ) {
			$score += 25;
		} else {
			$issues[] = __( 'Missing three-part structure', 'nvoos-content-graph-pro' );
		}

		if ( ! empty( $item['meta']['references'] ) ) {
			$score += 20;
		} else {
			$issues[] = __( 'Missing industry references', 'nvoos-content-graph-pro' );
		}
	...
	public static function handle_import() {
		...
		// Check user capability.
		if ( ! current_user_can( 'edit_posts' ) ) {
			wp_send_json_error( array( 'message' => __( 'You do not have permission to import specifications.', 'nvoos-content-graph-pro' ) ) );
		}
	...
	protected static function render_import_workflow() {
		...
		<div class="wp-mcp-ai-import-section">
			<h2><?php esc_html_e( 'Import Architectural Specification Data', 'nvoos-content-graph-pro' ); ?></h2>
			<p class="description">
				<?php esc_html_e( 'Import specifications from TXT, DOCX, PDF, CSV, JSON, or paste structured data. The AI will automatically parse and organize the specification information.', 'nvoos-content-graph-pro' ); ?>
			</p>
			
			<div class="import-tips">
				<h4><?php esc_html_e( 'Tips for better results:', 'nvoos-content-graph-pro' ); ?></h4>
				<ul>
					<li><?php esc_html_e( '✓ Include CSI division numbers (03-Concrete, 09-Finishes)', 'nvoos-content-graph-pro' ); ?></li>
					<li><?php esc_html_e( '✓ Follow three-part structure (Part 1: General, Part 2: Products, Part 3: Execution)', 'nvoos-content-graph-pro' ); ?></li>
					<li><?php esc_html_e( '✓ Include manufacturer specifications and model numbers', 'nvoos-content-graph-pro' ); ?></li>
					<li><?php esc_html_e( '✓ Reference industry standards (ASTM, ANSI, UL)', 'nvoos-content-graph-pro' ); ?></li>
				</ul>
			</div>
			...
			<div class="import-form">
				...
				<form id="wp-mcp-ai-import-form" method="post" enctype="multipart/form-data">
					...
					<div class="import-file-section">
						...
						<p class="description"><?php esc_html_e( 'Supported: TXT, DOCX, PDF, CSV, JSON', 'nvoos-content-graph-pro' ); ?></p>
					</div>
	...
	protected static function render_review_workflow() {
		...
		<div class="wp-mcp-ai-consolidate-section">
			<h2><?php esc_html_e( 'Specification Quality Dashboard', 'nvoos-content-graph-pro' ); ?></h2>
			...
			<div class="quality-dashboard">
				...
				<div class="quality-metrics">
					<div class="quality-metric">
						...
						<span class="quality-metric-label"><?php esc_html_e( 'Total Specifications', 'nvoos-content-graph-pro' ); ?></span>
					</div>
					<div class="quality-metric">
					...
					<div class="quality-metric">
						...
						<span class="quality-metric-label"><?php esc_html_e( 'With Division', 'nvoos-content-graph-pro' ); ?></span>
					</div>
					<div class="quality-metric">
						<span class="quality-metric-value"><?php echo esc_html( $with_structure ); ?></span>
						<span class="quality-metric-label"><?php esc_html_e( 'With Structure', 'nvoos-content-graph-pro' ); ?></span>
					</div>
				</div>
					...
					<div class="notice notice-warning inline">
						<p>
							...
							printf(
								...
								esc_html__( 'Specification completeness is %d%%. Consider adding CSI divisions, three-part structure, and industry references to improve quality.', 'nvoos-content-graph-pro' ),
			...
			<div class="items-list-table">
				...
				<p>
					...
					<a href="<?php echo esc_url( admin_url( 'post-new.php?post_type=mcp_ai_arch_spec' ) ); ?>" class="button">
						<?php esc_html_e( 'Add New Specification', 'nvoos-content-graph-pro' ); ?>
					</a>
