 ...
 *
 * Ported from the base Pro addon's `addons/pro/includes/mcp-servers/servers/class-wp-mcp-ai-architect-agent-mcp-server.php` for the standalone
...
class WP_MCP_AI_Architect_Agent_MCP_Server extends WP_MCP_AI_Toolkit_Server_Base {
	...
	public function get_name() {
		return __( 'Architect Agent', 'nvoos-content-graph-pro' );
	}
