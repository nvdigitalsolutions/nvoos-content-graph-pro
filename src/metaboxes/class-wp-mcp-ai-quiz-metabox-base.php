<?php
/**
 * metaboxes/class-wp-mcp-ai-quiz-metabox-base.php (ecosystem port — Wave F5, quiz-management data layer).
 *
 * Ported from the base Pro addon's `addons/pro/includes/metaboxes/class-wp-mcp-ai-quiz-metabox-base.php` for the
