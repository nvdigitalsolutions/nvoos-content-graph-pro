<?php
/**
 * metaboxes/places/class-wp-mcp-ai-place-metabox-base.php (ecosystem port — Wave F6, places data layer).
 *
 * Ported from the base Pro addon's `addons/pro/includes/metaboxes/places/class-wp-mcp-ai-place-metabox-base.php` for the
