...
class WP_MCP_AI_Tool_Import_DJ_Management_Blueprint implements WP_MCP_AI_Tool_Interface, WP_MCP_AI_Tool_Capability_Flags_Interface {
	...
	const BLUEPRINTS_DIR = NVOOS_CONTENT_GRAPH_PRO_PATH . 'src/tools/dj-management/examples';
	...
	public static function get_unavailable_reason() {
		return __( 'The Import DJ Management Blueprint tool requires the DJ Management Toolkit to be enabled in plugin settings.', 'nvoos-content-graph-pro' );
	}
	...
	public function get_name() {
		return __( 'Import DJ Management Blueprint', 'nvoos-content-graph-pro' ); }
	/**
	 * {@inheritdoc}
	 */
	public function get_description() {
		return __( 'Install a curated DJ management assistant blueprint for business management or event booking coordination workflows.', 'nvoos-content-graph-pro' ); }
