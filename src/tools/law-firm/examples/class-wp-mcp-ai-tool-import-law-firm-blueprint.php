<?php
/**
 * examples/class-wp-mcp-ai-tool-import-law-firm-blueprint.php (ecosystem port — Wave F4, law-firm research-analytics batch + blueprint).
 *
 * Ported from the base Pro addon's `addons/pro/includes/tools/law-firm/examples/class-wp-mcp-ai-tool-import-law-firm-blueprint.php` for the
...
class WP_MCP_AI_Tool_Import_Law_Firm_Blueprint implements WP_MCP_AI_Tool_Interface, WP_MCP_AI_Tool_Capability_Flags_Interface {
	...
	const BLUEPRINTS_DIR = NVOOS_CONTENT_GRAPH_PRO_PATH . 'src/tools/law-firm/examples';
	...
	public static function get_unavailable_reason() {
		return __( 'The Import Law Firm Blueprint tool requires the Law Firm Toolkit to be enabled in plugin settings.', 'nvoos-content-graph-pro' );
	}
	...
	public function get_name() {
		return __( 'Import Law Firm Blueprint', 'nvoos-content-graph-pro' ); }
	/**
	 * {@inheritdoc}
	 */
	public function get_description() {
		return __( 'Install a curated law firm assistant blueprint for litigation associate, managing partner, paralegal, or compliance officer workflows.', 'nvoos-content-graph-pro' ); }
