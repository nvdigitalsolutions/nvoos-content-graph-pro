...
class WP_MCP_AI_Tool_Import_Image_Production_Blueprint implements WP_MCP_AI_Tool_Interface, WP_MCP_AI_Tool_Capability_Flags_Interface {
	...
	const BLUEPRINTS_DIR = NVOOS_CONTENT_GRAPH_PRO_PATH . 'src/tools/image-production/examples';
	...
	public static function get_unavailable_reason() {
		return __( 'The Import Image Production Blueprint tool requires the Image Production Toolkit to be enabled.', 'nvoos-content-graph-pro' );
	}
	...
	public function get_name() {
		return __( 'Import Image Production Blueprint', 'nvoos-content-graph-pro' ); }
	/**
	 * {@inheritdoc}
	 */
	public function get_description() {
		return __( 'Install the Creative Image Producer assistant blueprint for AI-powered image generation, editing, and optimization workflows.', 'nvoos-content-graph-pro' ); }
