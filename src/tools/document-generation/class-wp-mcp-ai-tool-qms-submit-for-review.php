<?php
/**
 * WP_MCP_AI_Tool_QMS_Submit_For_Review (ecosystem port - Wave F2, document-generation tool batch).
 *
...
class WP_MCP_AI_Tool_QMS_Submit_For_Review implements WP_MCP_AI_Tool_Interface, WP_MCP_AI_Tool_Capability_Flags_Interface {
	...
	public function get_name() {
		return __( 'QMS: Submit for Review', 'nvoos-content-graph-pro' );
	}
	/**
	...
	public function get_description() {
		return __( 'Transition a controlled document from draft to in_review state. At least one reviewer must be assigned.', 'nvoos-content-graph-pro' );
	}
		/**
