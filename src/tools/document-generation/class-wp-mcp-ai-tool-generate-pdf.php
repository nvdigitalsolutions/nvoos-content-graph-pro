<?php
/**
 * WP_MCP_AI_Tool_Generate_PDF (ecosystem port - Wave F2, document-generation tool batch).
 *
...
class WP_MCP_AI_Tool_Generate_PDF implements WP_MCP_AI_Tool_Interface, WP_MCP_AI_Tool_Capability_Flags_Interface {
	...
	public function get_name() {
		return __( 'Generate PDF', 'nvoos-content-graph-pro' );
	}
	...
	public function get_description() {
		return __( 'Generate PDF documents from content. Simplified interface for creating PDFs with basic formatting and structure. For advanced features, use Pro PDF Document tool.', 'nvoos-content-graph-pro' );
	}
	...
	public function get_parameters_schema() {
		return array(
			...
			'properties' => array(
				'content' => array(
					'type'        => 'string',
					'description' => __( 'Content to include in the PDF document.', 'nvoos-content-graph-pro' ),
				),
				'title'   => array(
					'type'        => 'string',
