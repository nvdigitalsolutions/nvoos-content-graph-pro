...
if ( ! class_exists( 'WP_MCP_AI_Tool_Cloudways_App_FPM_Settings_Get' ) ) {
	...
	class WP_MCP_AI_Tool_Cloudways_App_FPM_Settings_Get extends WP_MCP_AI_Tool_Cloudways_Base {
		...
		public function get_name() {
			return __( 'Get App FPM Settings', 'nvoos-content-graph-pro' );
		}

		/** {@inheritdoc} */
		public function get_description() {
			return __( 'Retrieve current PHP-FPM configuration for an application.', 'nvoos-content-graph-pro' );
		}
		...
		public function execute( array $arguments = array(), array $context = array() ) {
			...
			return $this->success(
				__( 'PHP-FPM settings retrieved.', 'nvoos-content-graph-pro' ),
