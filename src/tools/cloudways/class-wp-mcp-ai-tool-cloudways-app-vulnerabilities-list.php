...
if ( ! class_exists( 'WP_MCP_AI_Tool_Cloudways_App_Vulnerabilities_List' ) ) {
	...
	class WP_MCP_AI_Tool_Cloudways_App_Vulnerabilities_List extends WP_MCP_AI_Tool_Cloudways_Base {
		...
		public function get_name() {
			return __( 'List App Vulnerabilities', 'nvoos-content-graph-pro' );
		}

		/** {@inheritdoc} */
		public function get_description() {
			return __( 'List WordPress vulnerabilities with severity scores for an application.', 'nvoos-content-graph-pro' );
		}
		...
		public function execute( array $arguments = array(), array $context = array() ) {
			...
			return $this->success(
				sprintf(
					...
					_n( 'Found %d vulnerability.', 'Found %d vulnerabilities.', count( $vulnerabilities ), 'nvoos-content-graph-pro' ),
