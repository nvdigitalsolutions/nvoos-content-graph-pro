...
if ( ! class_exists( 'WP_MCP_AI_Tool_Cloudways_App_Varnish_Settings_Get' ) ) {
	...
	class WP_MCP_AI_Tool_Cloudways_App_Varnish_Settings_Get extends WP_MCP_AI_Tool_Cloudways_Base {
		...
		public function get_name() {
			return __( 'Get App Varnish Settings', 'nvoos-content-graph-pro' );
		}

		/** {@inheritdoc} */
		public function get_description() {
			return __( 'Retrieve Varnish configuration (TTL, cacheable paths, exclusions) for an application.', 'nvoos-content-graph-pro' );
		}
		...
		public function execute( array $arguments = array(), array $context = array() ) {
			...
			return $this->success(
				__( 'Varnish settings retrieved.', 'nvoos-content-graph-pro' ),
