...
if ( ! class_exists( 'WP_MCP_AI_Tool_Cloudways_App_Restore_Rollback' ) ) {
	...
	class WP_MCP_AI_Tool_Cloudways_App_Restore_Rollback extends WP_MCP_AI_Tool_Cloudways_Base {
		...
		public function get_name() {
			return __( 'Rollback Restore', 'nvoos-content-graph-pro' );
		}

		/** {@inheritdoc} */
		public function get_description() {
			return __( 'Roll back the last backup restore action.', 'nvoos-content-graph-pro' );
		}
		...
		public function execute( array $arguments = array(), array $context = array() ) {
			...
			return $this->success(
				__( 'Restore rollback initiated.', 'nvoos-content-graph-pro' ),
				$result
			);
		}
	}
