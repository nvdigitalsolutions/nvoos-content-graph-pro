...
if ( ! class_exists( 'WP_MCP_AI_Tool_Cloudways_Cloudflare_Details' ) ) {
	...
	class WP_MCP_AI_Tool_Cloudways_Cloudflare_Details extends WP_MCP_AI_Tool_Cloudways_Base {
		...
		public function get_name() {
			return __( 'Cloudflare CDN Details', 'nvoos-content-graph-pro' );
		}

		/** {@inheritdoc} */
		public function get_description() {
			return __( 'View Cloudflare CDN status, configuration, and usage for an app.', 'nvoos-content-graph-pro' );
		}
		...
		public function execute( array $arguments = array(), array $context = array() ) {
			...
			return $this->success(
				__( 'Cloudflare CDN details retrieved.', 'nvoos-content-graph-pro' ),
