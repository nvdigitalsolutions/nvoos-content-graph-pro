...
if ( ! class_exists( 'WP_MCP_AI_Tool_Cloudways_App_Delete' ) ) {
	...
	class WP_MCP_AI_Tool_Cloudways_App_Delete extends WP_MCP_AI_Tool_Cloudways_Base {
		...
		public function get_name() {
			return __( 'Delete App', 'nvoos-content-graph-pro' );
		}

		/** {@inheritdoc} */
		public function get_description() {
			return __( 'Permanently delete an application and its data. THIS ACTION IS IRREVERSIBLE.', 'nvoos-content-graph-pro' );
		}
		...
		public function execute( array $arguments = array(), array $context = array() ) {
			...
			return $this->success(
				__( 'Application permanently deleted.', 'nvoos-content-graph-pro' ),
				$result
			);
		}
	}
