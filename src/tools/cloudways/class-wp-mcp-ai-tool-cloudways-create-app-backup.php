...
if ( ! class_exists( 'WP_MCP_AI_Tool_Cloudways_Create_App_Backup' ) ) {
	...
	class WP_MCP_AI_Tool_Cloudways_Create_App_Backup extends WP_MCP_AI_Tool_Cloudways_Base {
		...
		public function get_name() {
			return __( 'Create App Backup', 'nvoos-content-graph-pro' );
		}

		/** {@inheritdoc} */
		public function get_description() {
			return __( 'Create a backup of an application.', 'nvoos-content-graph-pro' );
		}
		...
		public function execute( array $arguments = array(), array $context = array() ) {
			...
			return $this->success(
				sprintf(
					...
					__( 'Backup initiated for app %d.', 'nvoos-content-graph-pro' ),
					$app_id
				),
				$result
			);
