...
if ( ! class_exists( 'WP_MCP_AI_Tool_Cloudways_Server_Clone' ) ) {
	...
	class WP_MCP_AI_Tool_Cloudways_Server_Clone extends WP_MCP_AI_Tool_Cloudways_Base {
		...
		public function get_name() {
			return __( 'Clone Server', 'nvoos-content-graph-pro' );
		}

		/** {@inheritdoc} */
		public function get_description() {
			return __( 'Clone an existing server to a new server with the same applications and optionally settings, domains, cron jobs, and SSL certificates.', 'nvoos-content-graph-pro' );
		}
		...
		public function get_parameters_schema() {
			return array(
				...
				'properties' => array(
					...
					'label'     => array(
						'type'        => 'string',
						'description' => __( 'Label for the new cloned server.', 'nvoos-content-graph-pro' ),
					),
				),
		...
		public function execute( array $arguments = array(), array $context = array() ) {
			...
			return $this->success(
				__( 'Server clone initiated.', 'nvoos-content-graph-pro' ),
				$result
			);
		}
	}
