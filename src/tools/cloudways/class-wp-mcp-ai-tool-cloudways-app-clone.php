...
if ( ! class_exists( 'WP_MCP_AI_Tool_Cloudways_App_Clone' ) ) {
	...
	class WP_MCP_AI_Tool_Cloudways_App_Clone extends WP_MCP_AI_Tool_Cloudways_Base {
		...
		public function get_name() {
			return __( 'Clone App', 'nvoos-content-graph-pro' );
		}

		/** {@inheritdoc} */
		public function get_description() {
			return __( 'Clone an application on the same server.', 'nvoos-content-graph-pro' );
		}
		...
		public function get_parameters_schema() {
			return array(
				...
				'properties' => array(
					...
					'label'     => array(
						'type'        => 'string',
						'description' => __( 'Label for the new cloned app.', 'nvoos-content-graph-pro' ),
					),
				),
