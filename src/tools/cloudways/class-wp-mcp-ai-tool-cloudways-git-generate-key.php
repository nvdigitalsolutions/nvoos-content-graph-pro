...
if ( ! class_exists( 'WP_MCP_AI_Tool_Cloudways_Git_Generate_Key' ) ) {
	...
	class WP_MCP_AI_Tool_Cloudways_Git_Generate_Key extends WP_MCP_AI_Tool_Cloudways_Base {
		...
		public function get_name() {
			return __( 'Generate Git Deploy Key', 'nvoos-content-graph-pro' );
		}

		/** {@inheritdoc} */
		public function get_description() {
			return __( 'Generate a fresh SSH deploy key for an application.', 'nvoos-content-graph-pro' );
		}
		...
		public function execute( array $arguments = array(), array $context = array() ) {
			...
			return $this->success(
				sprintf(
					...
					__( 'Git deploy key generated for app %d.', 'nvoos-content-graph-pro' ),
					$app_id
				),
				$result
			);
