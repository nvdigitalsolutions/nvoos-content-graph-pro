...
if ( ! class_exists( 'WP_MCP_AI_Tool_Cloudways_Git_Key_Get' ) ) {
	...
	class WP_MCP_AI_Tool_Cloudways_Git_Key_Get extends WP_MCP_AI_Tool_Cloudways_Base {
		...
		public function get_name() {
			return __( 'Get Git Deploy Key', 'nvoos-content-graph-pro' );
		}

		/** {@inheritdoc} */
		public function get_description() {
			return __( 'Retrieve the public SSH key generated for an application.', 'nvoos-content-graph-pro' );
		}
		...
		public function execute( array $arguments = array(), array $context = array() ) {
			...
			return $this->success(
				__( 'Git deploy key retrieved.', 'nvoos-content-graph-pro' ),
