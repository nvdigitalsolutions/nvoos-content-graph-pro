...
if ( ! class_exists( 'WP_MCP_AI_Tool_Cloudways_App_Credentials' ) ) {
	...
	class WP_MCP_AI_Tool_Cloudways_App_Credentials extends WP_MCP_AI_Tool_Cloudways_Base {
		...
		public function get_name() {
			return __( 'Get App Credentials', 'nvoos-content-graph-pro' );
		}

		/** {@inheritdoc} */
		public function get_description() {
			return __( 'Get SSH/SFTP credentials for an application.', 'nvoos-content-graph-pro' );
		}
		...
		public function execute( array $arguments = array(), array $context = array() ) {
			...
			return $this->success(
				sprintf(
					...
					__( 'Credentials retrieved for app %d.', 'nvoos-content-graph-pro' ),
					$app_id
				),
