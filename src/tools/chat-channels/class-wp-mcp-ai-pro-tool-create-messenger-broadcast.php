<?php
/**
 * tools/chat-channels/class-wp-mcp-ai-pro-tool-create-messenger-broadcast.php (ecosystem port — Wave F5, chat-channels tool batch).
 *
 * Ported from the base Pro addon's `addons/pro/includes/tools/chat-channels/class-wp-mcp-ai-pro-tool-create-messenger-broadcast.php` for the
...
class WP_MCP_AI_Pro_Tool_Create_Messenger_Broadcast implements WP_MCP_AI_Tool_Interface, WP_MCP_AI_Tool_Capability_Flags_Interface {
	...
	public function get_name() {
		return __( 'Create Messenger Broadcast', 'nvoos-content-graph-pro' );
	}
	...
	public function get_description() {
		return __( 'Sends a broadcast message to multiple Facebook Messenger users using the Messenger Platform API.', 'nvoos-content-graph-pro' );
	}
	...
	public function get_parameters_schema() {
		return array(
			...
			'properties'           => array(
				...
				'message'      => array(
					'type'        => 'string',
					'description' => __( 'Text content of the broadcast message to be sent.', 'nvoos-content-graph-pro' ),
				),
				'custom_label' => array(
					'type'        => 'string',
					'description' => __( 'Optional custom label ID to target specific users (targeting parameter).', 'nvoos-content-graph-pro' ),
				),
			),
	...
	public function execute( array $arguments = array(), array $context = array() ) {
		...
		if ( $required_capability && ( ! $user_id || ! user_can( $user_id, $required_capability ) ) ) {
			return new WP_Error( 'wp_mcp_ai_forbidden', __( 'You do not have permission to create Messenger broadcasts.', 'nvoos-content-graph-pro' ) );
		}
		...
		if ( false === $body ) {
			return new WP_Error( 'wp_mcp_ai_encoding_error', __( 'Failed to encode the Messenger broadcast request payload.', 'nvoos-content-graph-pro' ) );
		}
