<?php
/**
 * tools/chat-channels/class-wp-mcp-ai-pro-tool-get-whatsapp-messages.php (ecosystem port — Wave F5, chat-channels tool batch).
 *
 * Ported from the base Pro addon's `addons/pro/includes/tools/chat-channels/class-wp-mcp-ai-pro-tool-get-whatsapp-messages.php` for the
...
class WP_MCP_AI_Pro_Tool_Get_WhatsApp_Messages implements WP_MCP_AI_Tool_Interface, WP_MCP_AI_Tool_Capability_Flags_Interface {
	...
	public function get_name() {
		return __( 'Get WhatsApp Messages', 'nvoos-content-graph-pro' );
	}
	...
	public function get_description() {
		return __( 'Retrieves WhatsApp message history via the Meta Cloud API.', 'nvoos-content-graph-pro' );
	}
	...
	public function get_parameters_schema() {
		return array(
			...
			'properties'           => array(
				...
				'limit'           => array(
					'type'        => 'integer',
					'description' => __( 'Maximum number of messages to retrieve.', 'nvoos-content-graph-pro' ),
					'minimum'     => 1,
					'maximum'     => 100,
					'default'     => 25,
				),
				'after'           => array(
					'type'        => 'string',
					'description' => __( 'Optional cursor for pagination to fetch messages after this point.', 'nvoos-content-graph-pro' ),
				),
			),
	...
	public function execute( array $arguments = array(), array $context = array() ) {
		...
		if ( $required_capability && ( ! $user_id || ! user_can( $user_id, $required_capability ) ) ) {
			return new WP_Error( 'wp_mcp_ai_forbidden', __( 'You do not have permission to retrieve WhatsApp messages.', 'nvoos-content-graph-pro' ) );
		}
